setwd("/omics/groups/OE0246/internal/guz/cola_hc/examples/LawlorPancreas")
library(cola)
...
library(scRNAseq)
data = readRDS('/omics/groups/OE0246/internal/guz/cola_hc/examples/LawlorPancreas/LawlorPancreas_data.rds')
